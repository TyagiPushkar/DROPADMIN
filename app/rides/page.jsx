      ...
      <div className="mx-2">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            ...
            {/* Stats Cards - Matching the DriverLedger color scheme */}
        ...
        {/* Search and Filter Section - Matching DriverLedger */}
        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm mb-6">
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
            <div className="text-sm text-gray-600">
              Showing <span className="font-semibold">{filteredRides.length}</span> of <span className="font-semibold">{rides.length}</span> rides
            </div>
            <div className="text-sm text-gray-600">
              Updated just now
            </div>
